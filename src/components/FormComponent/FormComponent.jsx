...
const FormComponent = ({
  ...
  <>
    <label className="FormComponent">
      ...
      <input className={`FormComponent__input ${errorTxt && 'FormComponent__input_error'}`} maxLength={maxLength} minLength={minLength} placeholder={name} type={type} name={nameInput}
             required={required}/>
