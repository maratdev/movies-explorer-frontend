          ...
          <div className="Portfolio__wrap">
            ...
            <nav className="Portfolio__list">
              <a className="Portfolio__link" href="https://maratdev.github.io/how-to-learn/" target="_blank" >
                <p className="Portfolio__text reset-txt">Статичный сайт</p> <img className="Portfolio__image" src={arrow} alt=""/>
              </a>
              <a className="Portfolio__link" href="https://maratdev.github.io/russian-travel/" target="_blank">
                <p className="Portfolio__text reset-txt" >Адаптивный сайт</p> <img className="Portfolio__image" src={arrow} alt=""/>
              </a>
              <a className="Portfolio__link" href="https://maratdev.github.io/react-mesto-auth/" target="_blank">
                <p className="Portfolio__text reset-txt">Одностраничное приложение</p> <img className="Portfolio__image" src={arrow} alt=""/>
              </a>
            </nav>
          </div>
