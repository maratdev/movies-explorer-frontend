...
const AboutMe = () => (
  <section className="AboutMe">
    <div className="AboutMe__wrap">
      <h2 className="AboutMe__title reset-txt">Студент</h2>
      <div className="AboutMe__content">
        <h3 className="AboutMe__large-title reset-txt">Виталий</h3>
        <p className="AboutMe__info reset-txt">Фронтенд-разработчик, 30 лет</p>
        <p className="AboutMe__description reset-txt">Я родился и живу в Саратове, закончил факультет экономики СГУ.
          У меня есть жена
